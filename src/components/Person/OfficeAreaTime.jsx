...
import OFFICEICON from "../../Assets/working-man.png";
import Table from "./OfficeAreaTimeTable";

import "./index.css";
const pages = [""];
const settings = ["Logout"];
function OfficeAreaTime() {
		...
		<div>
			...
			<div style={{ display: "flex" }} className="my-3 mx-2">
				...
				<div className="MainDiv">
					...
					>
						{/* <Tooltip title="Office Area Time" placement="right-start">
							<img
								src={OFFICEICON}
