...
import LICON from "../../Assets/letter-l.png";
import Table from "./LoiteringTable";
		...
		<div>
			...
			<div style={{ display: "flex" }} className="my-3 mx-2">
				...
				<div className="MainDiv">
					...
					>
						{/* <Tooltip title="Loitering" placement="right-start">
							<img src={LICON} style={{ width: "10vh", height: "10vh" }} alt="LOGO" />
						</Tooltip> */}
						<Typography
							textAlign="center"
							style={{
