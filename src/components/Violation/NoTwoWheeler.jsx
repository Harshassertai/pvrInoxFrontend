...
import Table from "./NoTwoWheelerTable";

import "./index.css";
const pages = [""];
const settings = ["Logout"];

function NoTwoWheeler() {
		...
		<div>
			...
			<div style={{ display: "flex" }} className="my-3 mx-2">
				...
				<div className="MainDiv">
					...
					>
						{/* <Tooltip title="No Two Wheeler" placement="right-start">
							<img
