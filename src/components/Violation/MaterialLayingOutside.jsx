...
import BOXICON from "../../Assets/packages.png";
import Table from "./MaterialLayingOutsideTable";

import "./index.css";
const pages = [""];
const settings = ["Logout"];

function MaterialLayingOutside() {
		...
		<div>
			...
			<div style={{ display: "flex" }} className="my-3 mx-2">
				...
				<div className="MainDiv">
					...
					>
						{/* <Tooltip title="Material Laying Outside" placement="right-start">
							<img
								src={BOXICON}
...
export default MaterialLayingOutside;
