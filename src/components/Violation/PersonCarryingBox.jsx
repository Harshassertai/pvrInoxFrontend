...
import PERSONWITHBOXICON from "../../Assets/helping.png";
import Table from "./PersonCarryingBoxTable";

import "./index.css";
const pages = [""];
const settings = ["Logout"];

function PersonCarryingBox() {
		...
		<div>
			...
			<div style={{ display: "flex" }} className="my-3 mx-2">
				...
				<div className="MainDiv">
					...
					>
						{/* <Tooltip title="Person Carrying Boxes" placement="right-start">
							<img
								src={PERSONWITHBOXICON}
...
export default PersonCarryingBox;
