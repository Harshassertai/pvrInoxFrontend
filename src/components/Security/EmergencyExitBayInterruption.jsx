...
import EMERGENCYICON from "../../Assets/emergency-sign.png";
import Table from "./EmergencyExitBayInterruptionTable";

import "./index.css";
const pages = [""];
const settings = ["Logout"];

function EmergencyExitBayInterruption() {
		...
		<div>
			...
			<div style={{ display: "flex" }} className="my-3 mx-2">
				...
				<div className="MainDiv">
					...
					>
						{/* <Tooltip title="Emergency Exit Bay Interruption" placement="right-start">
							<img
								src={EMERGENCYICON}
...
export default EmergencyExitBayInterruption;
