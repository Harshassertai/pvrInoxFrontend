...
import Table from "./PersonWithoutVestAndHelmetTable";

import "./index.css";
const pages = [""];
const settings = ["Logout"];

function PersonWithoutVestAndHelmet() {
		...
		<div>
			...
			<div style={{ display: "flex" }} className="my-3 mx-2">
				...
				<div className="MainDiv">
					...
					>
						{/* <Tooltip title="Fire Extinguisher Not Available" placement="right-start">
							<img
...
export default PersonWithoutVestAndHelmet;
